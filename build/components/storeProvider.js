    ...
    return _temp = _class = /*#__PURE__*/function (_React$PureComponent) {
      ...
      _createClass(_class, [{
        ...
        value: function componentDidMount() {
          this.subscriptionId = this.context.store.subscribe(this.onStoreChange); //this.props.store.startClock();
        }
      }, {
        ...
        value: function render() {
          return /*#__PURE__*/_react["default"].createElement(Component, _extends({}, this.props, this.usedState(), {
      ...
      return _class;
    }(_react["default"].PureComponent), _defineProperty(_class, "displayName", "".concat(Component.name, "Container")), _defineProperty(_class, "contextTypes", {
